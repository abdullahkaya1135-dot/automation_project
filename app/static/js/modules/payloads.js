...
} from "./constants.js?v=20260629-label-material-availability-v1";
import { localIsoDate } from "./dates.js?v=20260629-label-material-availability-v1";
import { selectedShopOrderOption } from "./shop-orders.js?v=20260629-label-material-availability-v1";
import { expandTemperatureShorthand } from "./temperature.js?v=20260629-label-material-availability-v1";
import {
  cleanOptional,
  cleanRequired,
  numericContextId,
